...
public interface GeneratorConsts {
	...
	String TABLE_NAME = "LAND_PARTTIME_JOB"; // 表名
	String TARGET_DIR = "jsp/land/parttimejob/"; // 生成代码存放目录
	String URL_PREFIX="land";//请求前缀
	String BASE_FOLDER="src/main/java/";//maven目录
	String BASE_PACKAGE="org.sky.land";//生成java基础包名
}
