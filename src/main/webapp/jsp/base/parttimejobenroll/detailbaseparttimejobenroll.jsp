...
<script type="text/javascript" src='${basepath}jsp/base/parttimejobenroll/detailbaseparttimejobenroll.js'></script>
...
<div class="easyui-panel"  style="width:100%;height:100%;text-align: center;"
	 data-options="footer:'#detailPageButtonsFt'">
		<form id="detailbaseparttimejobenrollform" class="easyui-form" method="post" 
