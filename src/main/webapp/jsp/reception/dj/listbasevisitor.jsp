...
<div data-options=" region:'center',iconCls: 'icon-table'" title="来访信息管理">
<table  id="listbasevisitordg" class="easyui-datagrid" style="width: 100%; height: 100%"
	data-options="
			region:'center',
			fit:true,
			border:false,
			...
			onDblClickRow:function(rowIndex, rowData){
								//SKY_EASYUI.beginEdit('listbasevisitordg',rowIndex);
						  },
...
<div id="tb" style="height: auto">
	<a href="javascript:void(0)" class="easyui-linkbutton"
		data-options="iconCls:'icon-add',plain:true" onclick="addBaseVisitor()">增加</a>
	<a href="javascript:void(0)" class="easyui-linkbutton"
		data-options="iconCls:'icon-edit',plain:true" onclick="editBaseVisitor()">修改</a>
	<a href="javascript:void(0)" class="easyui-linkbutton"
		data-options="iconCls:'icon-20130408025545236_easyicon_net_30',plain:true" onclick="delBaseVisitor()">删除</a>
	<a href="javascript:void(0)" class="easyui-linkbutton"
		data-options="iconCls:'icon-06',plain:true" onclick="detailBaseVisitor()">查看明细</a>
</div>
</body>
</html>