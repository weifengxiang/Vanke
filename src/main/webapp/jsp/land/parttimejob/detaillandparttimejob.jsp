...
<script type="text/javascript" src='${basepath}jsp/land/parttimejob/detaillandparttimejob.js'></script>
...
<div class="easyui-panel"  style="width:100%;height:100%;text-align: center;"
	 data-options="footer:'#detailPageButtonsFt'">
		<form id="detaillandparttimejobform" class="easyui-form" method="post" 
