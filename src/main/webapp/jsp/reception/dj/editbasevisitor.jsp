...
<script type="text/javascript" src='${basepath}jsp/reception/dj/editbasevisitor.js'></script>
...
<div class="easyui-panel"  style="width:100%;height:100%;text-align: center;"
	 data-options="footer:'#editPageButtonsFt',border:false,fit:true">
		<form id="addeditbasevisitorform" class="easyui-form" method="post" 
...
<div id='editPageButtonsFt' style="text-align:center; padding:0px; top:0px">
	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls='icon-save'
		onclick="submitAddEditBaseVisitorForm()">保存</a> 
