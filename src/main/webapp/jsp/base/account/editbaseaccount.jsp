...
<script type="text/javascript" src='${basepath}jsp/base/account/editbaseaccount.js'></script>
...
<div class="easyui-panel"  style="width:100%;height:100%;text-align: center;"
	 data-options="footer:'#editPageButtonsFt'">
		<form id="addeditbaseaccountform" class="easyui-form" method="post" 
			...
			<table style="width:100%">
				  ...
				  <tr>
					...
					<td><input class="easyui-textbox" name="balance"
						data-options="required:true"></input></td>
				  </tr>
				  <tr>
...
<div id='editPageButtonsFt' style="text-align:center; padding:0px; top:0px">
	<a href="javascript:void(0)" class="easyui-linkbutton" iconCls='icon-save'
		onclick="submitAddEditBaseAccountForm()">保存</a> 
